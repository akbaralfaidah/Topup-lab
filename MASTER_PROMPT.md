...
Phases 0–7 are accepted. The user's Phase 8 request authorizes a shared pricing engine and strictly local demo pricing-rule administration, while preserving the public quote boundary. Drizzle ORM remains accepted. Do not implement authentication, production admin authorization, persistent orders, payments, provider calls, wallet changes or other business mutations. See docs/domain-model.md, docs/phase-3-live-validation.md, docs/demo-data.md, docs/phase-5-homepage.md, docs/phase-6-catalog.md, docs/phase-7-product-checkout.md and docs/phase-8-pricing.md for these milestones.
